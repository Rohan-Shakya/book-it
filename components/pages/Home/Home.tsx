        ...
        <div className="col-sm-12 col-md-6 col-lg-3 my-3">
          <div className="card p-2">
            <Image
              ...
              alt="Charming Studio 10 Miles to Wells' Beaches!"
            />
        ...
        <div className="col-sm-12 col-md-6 col-lg-3 my-3">
          <div className="card p-2">
            <Image
              ...
              alt="Picturesque 2-Story Farmhouse w/Private Hot Tub"
            />
            <div className="card-body d-flex flex-column">
              <h5 className="card-title">
        ...
        <div className="col-sm-12 col-md-6 col-lg-3 my-3">
          <div className="card p-2">
            <Image
              ...
              alt="Downtown Portsmouth Private Getaway! Hot Tub"
            />
            <div className="card-body d-flex flex-column">
              <h5 className="card-title">
        ...
        <div className="col-sm-12 col-md-6 col-lg-3 my-3">
          <div className="card p-2">
            <Image
              ...
              alt="Spacious Suite in a quiet Boston neighborhood."
            />
            <div className="card-body d-flex flex-column">
              <h5 className="card-title">
